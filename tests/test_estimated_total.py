...
# purchased-but-unconfirmed rank with a guess, with a small blue note
# spelling out how much of that came from estimates. Critically, nothing
# else in the app - Progression's own running total, chief among them -
# is ever computed from the blended figure; that's the number that used
# to matter for affordability before the total-points/remaining concept
# was removed, and still matters for Progression's owned/to-go split and
# per-step running totals. This is a real shared build with several
# purchased-but-unconfirmed ranks (Combat Stability, First Aid, Innate
# Eminence, Improved Mend), independently verified by hand: real total
# 167, guesses add 32, so the headline should read "~199".
#
...
with sync_playwright() as p:
    ...
    print("PASS: headline blends to ~199 in blue, note explains the +32 delta")
